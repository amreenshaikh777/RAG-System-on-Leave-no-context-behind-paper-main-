...
st.title("🔍 LLMs & LangChain: Advanced RAG System from PDF 📄")
st.subheader("📑 Let AI Enhance Your PDF Navigation with RAG Technology")

user_input = st.text_input("Ask me anything from Leave No Context behind paper...")
